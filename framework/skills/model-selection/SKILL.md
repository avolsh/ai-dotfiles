...
description: "AI model tier assignment for Plan step. Use when breaking specs into tasks, selecting model tiers, or setting up IDE model configuration."
---
...
*Model mapping verified: 2026-04-04*

Recommendations for choosing AI models by **capability tier**, not by model
name. Model names change frequently; the decision logic stays stable.

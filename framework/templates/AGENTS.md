...
by `scripts/sync-agents.sh` (the project-local copy of the canonical script
shipped at `<system>/templates/scripts/sync-agents.sh`).
...
`.github/copilot-instructions.md` and `scripts/sync-agents.sh` are in place.

...
Framework overview, skill catalog, two-scope resolution, non-Copilot notes: `<system>/docs/ai-agent-framework.md`. Project-bootstrap authoring: `<system>/docs/project-bootstrap-guide.md`.

...
This is the **source of truth** for product and technical documentation.
...
<!-- Add project-specific sections below: Overview, Glossary, Reference,
     Requirements, How-To, Product, ADR, Branding, etc. -->

...
*Generated by `make sync-system-templates` from `$AI_DOTFILES/framework/templates/system/_canonical.md` — do not edit this file. Edit the canonical source. Rendered file: `$AI_DOTFILES/framework/templates/system/claude/CLAUDE.md`.*

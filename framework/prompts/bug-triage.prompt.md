...
## Steps
1. **Load context** — project `.github/copilot-instructions.md`, [`spec-types.md`](../spec-workflows/spec-types.md), [`bug-questions.md`](../spec-workflows/questions/bug-questions.md), project `module-map.md`, and any `docs/domain/<feature>.md` baselines per [`docs/baseline-citations.md`](../../docs/baseline-citations.md).

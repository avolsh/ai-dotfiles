...
- [ ] **Review findings shown before fixing** — after every reviewer run,
      at any tier, post the reply verbatim with a proposed disposition per
      finding, mark those that would change approved requirements, ACs,
      Design or an ADR, and edit nothing until the owner decides; see
